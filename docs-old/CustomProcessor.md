...
`curl -sS -X POST -i -F jarFile=@../core/target/core-0.1.0-beta.jar  http://localhost:8080/api/v1/catalog/streams/componentbundles/PROCESSOR/custom -F customProcessorInfo=@console_custom_processor`
