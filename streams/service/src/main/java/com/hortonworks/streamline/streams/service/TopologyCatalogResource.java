...
public class TopologyCatalogResource {
    ...
    public Response addEngineTemplateMetricsBundle(EngineTemplateMetricsBundle engineTemplateMetricsBundle, @Context SecurityContext securityContext) {
        ...
        EngineTemplateMetricsBundle createdEngineBundle = catalogService.addEngineTemplateMetricsBundle(engineTemplateMetricsBundle);
        SecurityUtil.addAcl(authorizer, securityContext, EngineTemplateMetricsBundle.NAME_SPACE, createdEngineBundle.getId(),
                EnumSet.allOf(Permission.class));
