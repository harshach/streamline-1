...
public class EnvironmentService {
    ...
    public Collection<Service> getServiceForNamespace(Namespace namespace, String serviceName) {
        Collection<NamespaceServiceClusterMap> serviceClusterMappings =
                listServiceClusterMapping(namespace.getId(), serviceName);
        ...
        for (NamespaceServiceClusterMap mapping : serviceClusterMappings) {
            ...
            Service service = getServiceByName(clusterId, serviceName);
            if (service == null) {
    ...
    public Optional<Component> getComponent(Service service, String componentName) {
        Collection<Component> allComponents = listComponents(service.getId());
    ...
    public Optional<ServiceConfiguration> getServiceConfiguration(Service service, String serviceConfigurationName) {
        Collection<ServiceConfiguration> allServiceConfigurations = listServiceConfigurations(service.getId());
