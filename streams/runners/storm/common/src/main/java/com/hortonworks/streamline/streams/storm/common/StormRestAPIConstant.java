...
public class StormRestAPIConstant {
    ...
    public static final String STATS_JSON_WINDOW = "window";
    public static final String STATS_JSON_EXECUTED_TUPLES = "executed";
    public static final String STATS_JSON_OUTPUT_TUPLES = "outputRecords";
    ...
    public static final String STATS_JSON_ACKED_TUPLES = "ackedRecords";
    public static final String STATS_JSON_FAILED_TUPLES = "failedRecords";
    public static final String STATS_JSON_TOPOLOGY_ERROR_COUNT = "errors";
    public static final String STATS_JSON_UPTIME_SECS = "uptime";
    public static final String STATS_JSON_THROUGHPUT = "throughput";
