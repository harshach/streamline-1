  ...
  d3.timeline = function() {
    ...
    function timeline (gParent) {
      ...
      if (tickFormat.tickValues != null) {
        ...
        xAxis.ticks(tickFormat.numTicks || timeUnit ? d3.time[timeUnit.toLowerCase()] : tickFormat.tickTime , timeInterval ? timeInterval : tickFormat.tickInterval);
      }
